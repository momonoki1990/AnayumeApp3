...
public class DBAdapter {
    ...
    private final static String DB_NAME = "DB";      // DB名
    private final static String DB_TABLE = "DateDreamDB";       // DBのテーブル名
    ...
    public final static String COL_DREAM = "dream";    // 夢
     ...
     * @param dream　夢
     */
    public void saveDB(String date, String dream) {
        db.beginTransaction();          // トランザクション開始
        try {
            ContentValues values = new ContentValues();     // ContentValuesでデータを設定していく
            values.put(COL_DATE, date);
            values.put(COL_DREAM, dream);
